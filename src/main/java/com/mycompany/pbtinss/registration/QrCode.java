...
import com.mycompany.pbtinss.registration.PlateScanner;
...
public static BufferedImage getQRCodeImageInBasicFormat(String dataText, int width, int height) throws Exception {
        com.google.zxing.common.BitMatrix matrix = new com.google.zxing.MultiFormatWriter()
                .encode(dataText, com.google.zxing.BarcodeFormat.QR_CODE, width, height);
