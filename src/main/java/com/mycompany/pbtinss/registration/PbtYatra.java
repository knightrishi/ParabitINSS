...
import com.mycompany.pbtinss.registration.LiveGraph;
import com.mycompany.pbtinss.registration.PbtEmpLog;
import com.mycompany.pbtinss.registration.PbtMoreDetails;
import com.mycompany.pbtinss.registration.PbtRegCheck;
 ...
 PbtVehReg dialog;
   ...
   public void run(){
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(cb6, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(188, 188, 188))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        PersonReg personDialog = new PersonReg(this, true);
    ...
    private void cb6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb6ActionPerformed
        ...
        try {
            // Instantiate your existing standalone Chart engine or LiveChart class
            com.mycompany.pbtinss.registration.LiveChart liveChartWindow = new com.mycompany.pbtinss.registration.LiveChart();
            javafx.stage.Stage stage = new javafx.stage.Stage();
            
            // Build and mount scene structure
            javafx.scene.Scene scene = liveChartWindow.initChart();
            stage.setTitle("ParabitINSS - Sector Real-Time Analytics Telemetry");
            stage.setScene(scene);
            
            // Render popup window overlay over the AWT active layout bounds
            stage.show();
        } catch (Exception ex) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Error opening telemetry graph canvas: " + ex.getMessage(), 
                "Module Failure", javax.swing.JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    });
    ...
    private javax.swing.JButton cb6;
